...
export default class GunMenu extends Container {
    constructor() {
        ...
        this.btn_gatling = new Button(images.button_gun_sparks, () => this.addGun(GUN_TYPE.GATLING), true)
        this.btn_gatling.position.set(-110, -55)
        ...
        this.addChild(
            this.btn_gatling, this.btn_radar, this.btn_rocketer,
