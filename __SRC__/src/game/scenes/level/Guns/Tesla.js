...
export default class Tesla extends Container {
    constructor(enemies) {
        super()
        this.base = new Sprite(atlases.gun_tesla.textures["base_" + getLevel()])
        this.base.anchor.set(0.5)
        this.addChild(this.base)

        this.energy = new AnimatedSprite(atlases.gun_tesla.animations.energy)
        this.energy.anchor.set(0.5)
        this.energy.loop = false
        this.energy.animationSpeed = 0.5
        this.energy.alpha = 0
        this.addChild(this.energy)

        this.top = new AnimatedSprite(atlases.gun_tesla.animations.top) // top-energy
        this.top.anchor.set(0.5)
        this.top.loop = false
        this.top.animationSpeed = 0.5
